...
def pretraining(fold):
    ...
    for i in [3, 13, 20]:
        train_additional_df = train_additional_df[train_additional_df['species_id'] != i]

    # print(train_additional_df['species_id'].value_counts())
...
for use_fold in range(5):
    with trace(f'finetune fold {use_fold}'):
        args.pretrain_weights = f"pretrainings/EXP020/fold-{use_fold}.bin"
